...
setuptools.setup(
    ...
    install_requires=[
        ...
        "regorus @ https://github.com/PyPkgHub/regorus-wrapper/releases/download/0.2.2/regorus-0.2.2-cp39-cp39-macosx_10_12_x86_64.macosx_11_0_arm64.macosx_10_12_universal2.whl ; sys_platform == 'darwin' and python_version == '3.9'",
        "regorus @ https://github.com/PyPkgHub/regorus-wrapper/releases/download/0.2.2/regorus-0.2.2-cp310-cp310-macosx_10_12_x86_64.macosx_11_0_arm64.macosx_10_12_universal2.whl ; sys_platform == 'darwin' and python_version == '3.10'",
        "regorus @ https://github.com/PyPkgHub/regorus-wrapper/releases/download/0.2.2/regorus-0.2.2-cp311-cp311-macosx_10_12_x86_64.macosx_11_0_arm64.macosx_10_12_universal2.whl ; sys_platform == 'darwin' and python_version == '3.11'",
        "regorus @ https://github.com/PyPkgHub/regorus-wrapper/releases/download/0.2.2/regorus-0.2.2-cp312-cp312-macosx_10_12_x86_64.macosx_11_0_arm64.macosx_10_12_universal2.whl ; sys_platform == 'darwin' and python_version == '3.12'",
    ],
)